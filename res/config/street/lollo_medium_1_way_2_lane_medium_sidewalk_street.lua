function data()
    return {
        ...
        type = 'lollo_medium_1_way_2_lane_medium_sidewalk_street.lua',
        name = _('Medium 1-way street with 2 lanes and 2m pavement'),
        desc = _('Medium 1-way street with 2 lanes. The pavement is 2m wide. Speed limit is %2%.'),
        categories = {'one-way'},
