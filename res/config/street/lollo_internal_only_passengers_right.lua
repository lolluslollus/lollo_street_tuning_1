function data()
    return {
        ...
        type = 'lollo_internal_only_passengers_right.lua',
        name = _('lollo_internal_only_passengers_right'),
        desc = _('lollo_internal_only_passengers_right'),
        --categories = {},
        materials = { },
        assets = {
            {
                name = 'lollo_assets/only_passengers.mdl',
                -- offset = 8.0,
                -- distance = 16.0,
                offset = 6.0,
                distance = 12.0,
