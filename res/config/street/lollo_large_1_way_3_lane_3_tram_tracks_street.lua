function data()
    return {
        ...
        country = false,
        speed = 60.0,
        type = "lollo_large_1_way_3_lane_3_tram_tracks_street",
        name = _("Large one-way street - 3 tram tracks"),
        desc = _("Large one-way street with 3 lanes, each with a tram track. Speed limit is %2%."),
        categories = { "one-way" },
